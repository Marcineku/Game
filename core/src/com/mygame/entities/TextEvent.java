...
/**
 * Used for displaying dynamic text that is fading (for example used for displaying damage dealt on screen)
 */
public class TextEvent {
    ...
    public TextEvent(SpriteBatch sb, BitmapFont font, String text, float fadingTime, Vector2 position, Color color, float speed, float fadingOffset) {
        this.sb = sb;
