...
/**
 * Contains box2d physics object, all animations and information related to gold that is dropping from dead enemies
 */
public class Gold extends Sprite {
    ...
    /**
     * @param world box2d world object in which gold's collider will be spawned
     * @param positionX x coordinate of spawning position
     * @param positionY y coordinate of spawning position
     * @param gold amount of gold it gives after pickup
     */
    public Gold(World world, float positionX, float positionY, int gold) {
